 ...
 *   `gasLimit`, sizes the opening wave; later waves size themselves from what the pages report.
 *   Over-estimating costs extra parallel requests, under-estimating costs one continuation wave.
