...
export type GetDeploymentBlockNumberParameters = {
...
export type GetDeploymentBlockNumberReturnType = bigint | null;
...
>(
  ...
  { address, fromBlock, toBlock }: GetDeploymentBlockNumberParameters,
): Promise<GetDeploymentBlockNumberReturnType> {
