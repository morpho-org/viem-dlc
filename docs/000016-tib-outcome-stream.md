...
> **Superseded in part by 000016-tib-page-telemetry.md**: the response carries five gas words
> between `nA` and the records, under the sentinel `ViemDlcPage3()`; `Page` gains `gas`; and
> `cpost` is 1,400.
